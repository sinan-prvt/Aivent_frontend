          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-12">
            {user ? (
              ...
              <>
                <Link
                  to="/magic-planner"
                  className="px-8 py-3 bg-white border-2 border-indigo-600 text-indigo-600 rounded-xl hover:bg-indigo-50 font-bold transition-all flex items-center gap-2"
                >
                  <FiZap />
                  Try Magic Planner
                </Link>
